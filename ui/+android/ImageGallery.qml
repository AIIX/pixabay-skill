       ...
       Item {
           ...
           Item {
               ...
               RoundButton {
                    ...
                    onClicked: {
                        triggerGuiEvent("pixabay.gallery.previous", {"galleryType": "Image", "currentPageNumber": pixaLoaderView.currentPageNumber})
                    }
               ...
               RoundButton {
                    ...
                    onClicked: {
                        triggerGuiEvent("pixabay.gallery.next", {"galleryType": "Image", "currentPageNumber": pixaLoaderView.currentPageNumber})
                    }                    
           ...
           RoundButton {
                ...
                imageWidth: Kirigami.Units.iconSizes.small
                onClicked: {
                    pixaLoaderView.parent.backRequested()
                }
        ...
        GridView {
            ...
            focus: true
            clip: true
            model: pixaLoaderView.imageGalleryModel
